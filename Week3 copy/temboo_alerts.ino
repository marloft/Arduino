*/
Adapted from Marco Schwartz. (2014). Internet of Things with the Arduino Yún Packt Publishing
https://github.com/openhomeautomation/geeky-projects-yun/tree/master/chapter1/temboo_alerts
/*
#include <Bridge.h>
#include <Temboo.h>
#include <Process.h>
